//! Embedded self-signed test chain, mirrored from src/test_pem.rs
//! (which is cfg(test)-gated and invisible to integration tests).
...
pub const TEST_LEAF_CERT_PEM: &str = "-----BEGIN CERTIFICATE-----
...
pub const TEST_LEAF_KEY_PEM: &str = "-----BEGIN PRIVATE KEY-----
...
pub const TEST_CERT_CN: &str = "rustydns-dot-test";
